// De bedienvelden voor één subactiviteit: 📌 startdatum, 🔒 bevestigen, duur bijstellen, en
// koppelen (Laag 3). Wordt getoond in het zijpaneel in Planning.tsx zodra een subactiviteit
// geselecteerd is — geen eigen in/uitklap-knop meer, de aanwezigheid van het paneel ís het "open".
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: 13 }}>
      ...
      <div className="veldrij">
        ...
        />
        <button type="button" className="knop-subtiel" onClick={() => onZetAnker('bevestigd', bevestigdatumVeld)}>
      ...
      <div className="veldrij">
        ...
        <button type="button" className="knop-subtiel" disabled={!koppelVeld} onClick={() => onZetKoppeling(koppelVeld)}>
          Koppel
        </button>
        {stap.gelijkMetSubId && (
          <button
